...
import { Calendar, Clock, Check, AlertCircle, Video, ChevronLeft, ChevronRight, ChevronDown, ChevronUp, RotateCcw, Ban, Mail, Sparkles } from 'lucide-react'
...
// â”€â”€ Candidate-facing light canvas â”€â”€
...
// â”€â”€ Reusable JD card â€” shown on every candidate view â”€â”€
  ...
  return (
    <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-white shadow-[0_8px_30px_rgba(168,85,247,0.08)] p-6 mb-5">
      <div className="flex items-center gap-2 mb-3">
        <img src="/geply-logo.png" alt="Geply" className="h-7 w-auto" />
...
export default function CandidateSchedule() {
  ...
  // â”€â”€ Already booked â€” show confirmation â”€â”€
  ...
  // â”€â”€ Scheduling / Rescheduling form â”€â”€
  return (
    <CandidateCanvas>
      <div className="max-w-lg mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-white shadow-[0_8px_30px_rgba(168,85,247,0.08)] p-6">
          ...
          {selectedDate && selectedTime && (
            <div className="mt-4 p-4 rounded-xl border" style={{
              ...
              <p className="text-xs text-brand-600 mt-0.5">45-minute AI interview Â· {tzLabel(Intl.DateTimeFormat().resolvedOptions().timeZone)}</p>
            </div>
          )}
